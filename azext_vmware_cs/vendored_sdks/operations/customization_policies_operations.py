...
class CustomizationPoliciesOperations(object):
    ...
    def list(
        ...
        deserialized = models.CustomizationPolicyPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.CustomizationPolicyPaged(internal_paging, self._deserialize.dependencies, header_dict)
